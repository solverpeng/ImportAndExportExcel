 ...
 * @author solverpeng
 */
public class ExportExcel_bk2 {

    private static Logger log = LoggerFactory.getLogger(ExportExcel_bk2.class);
     ...
     */
    public ExportExcel_bk2(String titleName, Class<?> cls) {
     ...
     * @param groups    导入分组
     */
    public ExportExcel_bk2(String titleName, Class<?> clazz, int type, int... groups) {
     ...
     * @param headers 表头数组
     */
    public ExportExcel_bk2(String titleName, String[] headers) {
     ...
     */
    public ExportExcel_bk2(String titleName, List<String> headerList) {
        initialize(titleName, headerList);
    }
     ...
     */
    public <E> ExportExcel_bk2 setDataList(List<E> list) {
        for (E e : list) {
            int column = 0;
            Row row = this.addRow();
     ...
     * 输出到浏览器
     */
    public ExportExcel_bk2 writeFile(String fileName, HttpServletRequest request, HttpServletResponse response) throws IOException {
