 ...
 * @author solverpeng
 */
public class ImportExcel_bk2 {

    private static Logger log = LoggerFactory.getLogger(ImportExcel_bk2.class);
     ...
     */
    public ImportExcel_bk2(String fileName, int headerNum) throws IOException {
     ...
     * @param headerNum 标题行号，数据行号=标题行号+1
     */
    public ImportExcel_bk2(File file, int headerNum) throws IOException {
     ...
     */
    public ImportExcel_bk2(String fileName, int headerNum, int sheetIndex) throws IOException {
     ...
     * @param sheetIndex 工作表编号
     */
    public ImportExcel_bk2(File file, int headerNum, int sheetIndex) throws IOException {
     ...
     * @param sheetIndex 工作表编号
     */
    public ImportExcel_bk2(MultipartFile multipartFile, int headerNum, int sheetIndex) throws IOException {
     ...
     * @param sheetIndex 工作表编号
     */
    public ImportExcel_bk2(String fileName, InputStream is, int headerNum, int sheetIndex) throws IOException {
