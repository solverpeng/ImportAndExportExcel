...
public class ExportExcel {
     ...
     */
    public ExportExcel(String titleName, Class<?> cls) {
     ...
     * @param groups    导入分组
     */
    public ExportExcel(String titleName, Class<?> clazz, int type, int... groups) {
     ...
     * @param headers   表头数组
     */
    public ExportExcel(String titleName, String[] headers) {
     ...
     */
    public ExportExcel(String titleName, List<String> headerList) {
        initialize(titleName, headerList);
    }
     ...
     * 输出到浏览器
     */
    public ExportExcel writeFile(String fileName, HttpServletRequest request, HttpServletResponse response) throws IOException {
